...
def main(argv):
    ...
    for subject in subfile:
		...
		for com in components:
			...
			activation_differenceabs[com.name] = abs(activation_in_roiabs/voxel_in_roi)
                    elif voxel_in_roi == 0:
		...
		# Then get the same value with it's +/- direction from activation_difference
		topmatch[1] = activation_difference[topmatch[0]]
		secondmatch[1] = activation_difference[secondmatch[0]]
		thirdmatch[1] = activation_difference[thirdmatch[0]]
